...
export interface LLMIntentResult {
  intent: "power" | "simple" | "effect" | "complex" | "save" | "recall" | "schedule";
  room_mention: string | null;
  device_mention: string | null;
  power_state: "on" | "off" | null;
  keywords: string[];
  time_mention: string | null;
  days_mention: string | null;
...
export const intentResultSchema = z.object({
  intent: z.enum(["power", "simple", "effect", "complex", "save", "recall", "schedule"]),
  room_mention: optStr,
